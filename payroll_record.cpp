...
PayrollRecord::PayrollRecord() : first_name_("it is"), last_name_("unknown"), pay_rate_(PayrollRecord::kMinimumWage), hours_(0){}
...
void PayrollRecord::set_name(std::string name)
{
 ...
 void PayrollRecord::WriteReport(std::ostream &outReport) const
 {
    ...
    << "   " << "Pay Rate: $" << std::fixed << std::setprecision(2) << pay_rate_ << std::endl
